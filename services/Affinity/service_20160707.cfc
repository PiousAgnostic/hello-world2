...
--->
	...
	<cffunction name="GetFacesheetNOKInfo" access="public" >
		...
		<cfset nQuery = QueryNew("NOK_ADDRESS,NOK_ADDRESS_2,NOK_CITY,NOK_HOME_PHONE_NUMBER,NOK_NAME,NOK_PATIENT_ID,NOK_RELATIONSHIP_TO_PATIENT,NOK_STATE,NOK_WORK_PHONE_NUMBER,NOK_ZIP_CODE,system")>
