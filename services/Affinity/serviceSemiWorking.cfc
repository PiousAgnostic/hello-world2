...
<cfset WEBURL = "http://svmmatrixdev02.orhs.org/Affinity/AffinityService.svc?singleWsdl">
...
--->
	...
	<cffunction name="GetFacesheetNOKInfo" access="public" >
		...
		<cfset nQuery = QueryNew("NOK_ADDRESS,NOK_ADDRESS_2,NOK_CITY,NOK_HOME_PHONE_NUMBER,NOK_NAME,NOK_PATIENT_ID,NOK_RELATIONSHIP_TO_PATIENT,NOK_STATE,NOK_WORK_PHONE_NUMBER,NOK_CELL_PHONE_NUMBER,NOK_ZIP_CODE,system")>

					<cfset temp = QueryAddRow(nQuery)>
					<cfset Temp = QuerySetCell(nQuery, "NOK_ADDRESS", "184 This street")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_ADDRESS_2", "02 steet 2")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_CITY", "this city")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_HOME_PHONE_NUMBER", "352-205-1212")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_NAME", "My Name Test")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_PATIENT_ID", "99999999")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_RELATIONSHIP_TO_PATIENT", "Mistress")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_STATE", "FL")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_WORK_PHONE_NUMBER", "321-843-4443")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_CELL_PHONE_NUMBER", "321-843-3131")>
					<cfset Temp = QuerySetCell(nQuery, "NOK_ZIP_CODE", "99499")>
					<cfset Temp = QuerySetCell(nQuery, "SYSTEM", "eagle")>
